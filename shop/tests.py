...
r.suggest_products_for([red_wine_1], 6)
r.suggest_products_for([red_wine_1, red_wine_2], 6)
r.suggest_products_for([red_wine_3, red_wine_2], 6)
r.suggest_products_for([red_wine_4, red_wine_1], 6)